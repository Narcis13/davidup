...
const shortcuts = computed<Shortcut[]>(() => [
  ...
  { keys: [`${modKey.value}`, '0'], label: 'Fit the whole composition in the timeline' },
  { keys: [`${modKey.value}`, '+'], label: 'Zoom the timeline in (or pinch / ⌘-scroll over it)' },
  { keys: [`${modKey.value}`, '−'], label: 'Zoom the timeline out' },
  { keys: ['⌥', 'drag'], label: 'Timeline bar drag without snapping (Snap toggle: frames + bar edges)' },
