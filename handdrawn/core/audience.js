...
// (s), contrast the least contrast ratio of text on what it is drawn over. general is what lint asked before
...
export const AUDIENCES = Object.freeze({
  general: Object.freeze({ text: 1, write: 16, read: 3.3, dwell: 0.5, count: 0.5, words: null, minX: 2.5, perWord: 0.15, cutFloor: 0, contrast: 3 }),
  beginner: Object.freeze({ text: 1.1, write: 14, read: 2.5, dwell: 0.7, count: 0.6, words: 16, minX: 3.5, perWord: 0.3, cutFloor: 1, contrast: 4.5 }),
  'kids-9': Object.freeze({ text: 1.2, write: 12, read: 2, dwell: 0.9, count: 0.7, words: 14, minX: 4, perWord: 0.4, cutFloor: 1.5, contrast: 4.5 }),
  'kids-7': Object.freeze({ text: 1.3, write: 11, read: 1.6, dwell: 1, count: 0.8, words: 10, minX: 4.5, perWord: 0.5, cutFloor: 2, contrast: 4.5 }),
  'kids-5': Object.freeze({ text: 1.4, write: 10, read: 1.2, dwell: 1.2, count: 1, words: 8, minX: 5, perWord: 0.7, cutFloor: 2.5, contrast: 4.5 }),
});
