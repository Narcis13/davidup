...
test('nine presets, each with the full role set', () => {
  assert.deepEqual(Object.keys(LOOKS), ['paperInk', 'risoPop', 'screenSea', 'pencilMinimal', 'blueprintNight', 'doodlePastel', 'cutout', 'whiteboard', 'chalkboard']);
