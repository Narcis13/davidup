...
const bulletList: TemplateDefinition = {
  id: "bulletList",
  description:
    "One to six bullets (default three) revealed with a staggered fade-in. Set `count` and supply bullet1..bulletN.",
  params: [
    {
      name: "count",
      type: "number",
      default: 3,
      description: "How many bullets to emit (1–6). Bullets need bullet1..bulletN.",
    },
    { name: "bullet1", type: "string", required: true },
    { name: "bullet2", type: "string" },
    { name: "bullet3", type: "string" },
    { name: "bullet4", type: "string" },
    { name: "bullet5", type: "string" },
    { name: "bullet6", type: "string" },
    ...
    { name: "y4", type: "number", default: 580 },
    { name: "y5", type: "number", default: 640 },
    { name: "y6", type: "number", default: 700 },
    {
      name: "font",
      type: "string",
      required: true,
  ...
  items: {
    // Ids stay b1..bN (the pre-$repeat names) so instances keep their item ids.
    b: {
      $repeat: { count: "${params.count}", as: "i", id: "b${i + 1}" },
      item: {
        type: "text",
        text: "${params['bullet' + (i + 1)]}",
        font: "${params.font}",
        fontSize: "${params.fontSize}",
        color: "${params.color}",
        align: "left",
