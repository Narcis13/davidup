...
function drawIsolatedGroup(
  ...
  // Same anchor translate `drawItem` applies, in the same place in the stack:
  // a group with a declared box (v1.3, L-3) pivots identically whether or not
  // it is isolated. A group without one contributes 0 and nothing happens.
